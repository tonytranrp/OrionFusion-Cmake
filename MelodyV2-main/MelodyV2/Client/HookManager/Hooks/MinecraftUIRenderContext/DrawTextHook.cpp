...
__int64 DrawTextHook::drawTextCallBack(MinecraftUIRenderContext* _this, FontBitmap* font, float* pos, std::string* text, MC_Color* color, float alpha, unsigned int textAlignment, TextMeasureData* textMeasureData, CaretMeasureData* caretMeasureData) {
	/*
...
void DrawTextHook::init(uintptr_t address) {
